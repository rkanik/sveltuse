<script lang="ts">
	...
	let title = 'SvelteUse - Composition Utilities'
	let description =
		'SvelteUse is an open-source UI component library built with Svelte components, Tailwind CSS utility classes and based on the Flowbite design system and components.'
