...
<Section>
	<div class="flex flex-col lg:flex-row gap-4 lg:gap-20">
		<div
			class="flex flex-col items-start justify-center gap-3 md:gap-5 w-full lg:mb-0 mb-4">
			<div class="flex flex-col items-start justify-center gap-6 w-full">
				<div class="flex flex-col items-start py-2">
					<Quote />
				</div>
				<div
					class="flex flex-col items-start justify-center gap-5 max-w-2xl pr-8 self-stretch">
					<p
						class="leading-relaxed text-lg font-medium text-gray-900 dark:text-white">
				...
				<div class="flex flex-row items-center gap-3.5 self-stretch">
					...
					<div class="flex items-center gap-3">
						<span
							class="leading-tight font-semibold text-gray-900 dark:text-white"
							>Eugene Fedorenko</span>
						<span
							class="leading-tight font-semibold text-gray-900 dark:text-white"
							>/</span>
						<span class="leading-tight font-normal text-sm"
							>Lead designer at Wildbit</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div
				...
				<a
					...
					<div class="flex flex-col items-start gap-2">
						<p
							class="leading-tight text-2xl font-bold text-gray-900 dark:text-white">
							{format(github)}
						</p>
						<p
							class="text-sm md:text-base text-gray-500 dark:text-gray-400">
							Stars on Github
						</p>
					</div>
				</a>
