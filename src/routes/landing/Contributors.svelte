...
<Section class="lg:py-24">
	...
	<div class="flex flex-col gap-12 items-center w-full max-w-7xl mx-auto">
		...
		<div
			class="flex flex-row items-center justify-between w-full max-w-5xl lg:px-4">
			<div
				...
				<div class="flex flex-col w-full">
					<h2
						class="tracking-tight text-xl font-bold text-left text-gray-900 dark:text-white">
						Join the community
					</h2>
					<p>
