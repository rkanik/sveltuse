...
<div class="mt-8 code-example">
	...
	<div class="code-preview-wrapper">
		<div
			class="flex p-0 bg-white border-gray-200 bg-gradient-to-r code-preview dark:bg-gray-900 border-x border-t rounded-t overflow-hidden dark:border-gray-600">
			<div class="w-full code-responsive-wrapper">
				<div
